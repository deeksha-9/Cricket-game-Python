...
class Ui_evaluate_team(object):
    ...
    def setupUi(self, evaluate_team):
        ...
        evaluate_team.setStyleSheet("background-color: rgb(206, 206, 206)")
        self.label = QtWidgets.QLabel(evaluate_team)
        self.label.setGeometry(QtCore.QRect(100, 20, 421, 51))
        font = QtGui.QFont()
...
"font: 75 9pt \"Comic Sans MS\";")
    ...
    def retranslateUi(self, evaluate_team):
        ...
        self.label.setText(_translate("evaluate_team", "<html><head/><body><p><span style=\" font-size:10pt;\">Evaluate the Performance of your Fantasy Team</span></p></body></html>"))
